...
2. If the user requests Hindi, the response MUST be in Devanagari script only. Using Latin characters for Hindi is not allowed.


STRICT language/script rules:
- If English → reply ONLY in English using Latin script.
- If Hindi → reply ONLY in pure Hindi using Devanagari script.
  DO NOT use Roman Hindi.
  DO NOT use Latin characters.
  DO NOT mix English words.
- If Hinglish → reply ONLY in Latin script (Roman Hindi).
- If Odia → reply ONLY in Odia script.
